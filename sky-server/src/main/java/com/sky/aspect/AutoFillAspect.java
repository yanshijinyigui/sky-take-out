...
public class AutoFillAspect {
    ...
    public void autoFill(JoinPoint joinPoint){
        ...
        if(autoFill.value().equals(OperationType.INSERT) ){
            //为4个公共字段赋值
            try {
               /** Field createTimeFiele= entity.getClass().getDeclaredField(AutoFillConstant.SET_CREATE_TIME);
                createTimeFiele.setAccessible(true);
                createTimeFiele.set(entity,LocalDateTime.now());*/
